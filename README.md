...
The REST API documentation can be found on [racks.cash](https://racks.cash). The full API of this library can be found in [api.md](api.md).
...
1. Via the `RACKS_LOG` environment variable
...
const client = new Racks({
  logger: logger.child({ name: 'Racks' }),
